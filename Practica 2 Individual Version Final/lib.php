...
echo $html;
    ...
    public static function navigationAdmin(){
        ...
        echo '<a href="nuevousuario.php">Nuevo usuario</a>';
        echo '</nav><br/>';
    }
    public static function navigationClientes(){
        ...
        echo '<a href="detallespedidos.php">Detalles pedidos</a>';
    ...
    public static function navigationRepartidores(){
        ...
        echo '<a href="pedidosenproceso.php">Mis pedidos asignados</a>';
        echo '</nav><br/>';
    }
